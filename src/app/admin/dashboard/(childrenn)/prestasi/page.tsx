    ...
    return (
        <>
            <div className="flex flex-col gap-10 w-11/12 mx-auto mt-10 ">
                ...
                <Link href={"/admin/dashboard/prestasi/add"} className="px-4 flex items-center  py-3 w-[100px] h-10 bg-blue-600 text-white rounded">Tambah</Link>
                <div className="mt-5 w-full flex flex-wrap justify-between gap-y-6">
                    <div className="w-full lg:w-[48%] xl:w-[32%]  min-h-96 shadow-lg rounded-md overflow-hidden">
                        <span className="w-full h-48 overflow-hidden inline-block">
                            <Image src={Wkk} alt="" width={800} height={800} className="hover:scale-110 duration-300 w-full h-full object-center object-cover"></Image>
                        </span>
                        ...
                        <Link className="my-2 py-2 px-4 bg-red-600 text-white font-bold rounded-md" href={""}>Hapus</Link>
                        </span>
                    </div>
                </div>
            </div>
